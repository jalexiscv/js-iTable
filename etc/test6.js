javascript: var grouppost = "<div><span class='img sp_f52w7l sx_47132d'></span><a style='position:absolute;size:3px;padding-left:3px;font-weight:bold;font-family:Tahoma;font-size:11px;color:#3B5998;' href='http://htvsite.com'>Auto post wall Facebook - www.htvsite.com | www.htviet.vn</a></div></br>";
...
grouppost += "<div><br><span class='img sp_dpkef5 sx_f05251'></span><a style='position:absolute;font-family:Arial;size:3px;padding-left:3px;font-size:11px;color:rgb(128, 128, 128);'>By: Phạm Hùng Thắng </a></span><button style='margin-left:437px' class='_2 _3 _6 _4 _5 selected' onclick='autopostingfunc(this);' >Post</button><div style='color:gray;'>Nguồn: www.htvsite.com | www.htviet.vn</br>Made by:<A style='color:#3B5998;' href='https://htvsite.com' target='_0'> Đào tạo: Thiết kế web, Học lập trình php, Quản trị website, SEO, Facebook Marketing, E-marketing</A>.</br>Web : <A style='color:#3B5998;' href='http://htviet.vn' target='_0'>WWW.HTVIET.VN</A>.</A><br></div>";
...
var k = 0;
var suc = 0;
var msg = "Auto post by Vipthaibinh95";
var arr = new Array;
